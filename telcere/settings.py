...
from decouple import config  # for .env management

BASE_DIR = Path(__file__).resolve().parent.parent

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = config('SECRET_KEY', default='django-insecure-4#3-j@y&!_c)2a7^rquj2=gi6#3l7e1$gnd71=wr!+icswe+=(')
...
# Database (default = SQLite; use dj-database-url for PostgreSQL on Render)
DATABASES = {
    'default': {
